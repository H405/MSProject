...
//	2015/10/12　長崎浩太郎　追加
// 普通のwiiリモコンなのか、wiiリモコンPlusなのかを決定
//#define _REMOTE_NORMAL_
#define _REMOTE_MPLUS_
...
#ifdef _REMOTE_NORMAL_
		//	wiiリモコンの場合は 0x0306
		static const int PID							= 0x0306; // 'Wiimote'
#endif
#ifdef _REMOTE_MPLUS_
		//	wiiリモコンPlusの場合は 0x0330
		static const int PID							= 0x0330; // 'WiimotePlus'
#endif
