...
//==============================================================================
int Polygon3D::Initialize( IDirect3DDevice9* pDevice )
{
	// メンバ変数の設定
	pDevice_ = pDevice;
	...
	{
		buffer.SetPosition( counterVertex, 1.0f * (counterVertex % COUNT_VERTEX_LINE) - 0.5f, 0.0f, -1.0f * (counterVertex / COUNT_VERTEX_LINE) + 0.5f );
		buffer.SetNormal( counterVertex, 0.0f, 1.0f, 0.0f );
...
// Arg    : IDirect3DDevice9* pDevice			: Direct3Dデバイス
//==============================================================================
int Polygon3D::Reinitialize( IDirect3DDevice9* pDevice )
{
	// 終了処理
	int		result;		// 実行結果
	result = Finalize();
...
//==============================================================================
int Polygon3D::Copy( Polygon3D* pOut ) const
{
	// 正常終了
	return 0;
}
...
// Arg    : void								: なし
//==============================================================================
void Polygon3D::InitializeSelf( void )
{
	// メンバ変数の初期化
	pDevice_ = nullptr;
	pVertexBuffer_ = nullptr;
